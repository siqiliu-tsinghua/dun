...
| F48 | Plugin protocol client | `dun-plugin` + `plugin.<id>.*` config + wiring + syntax rendering | req | A | 86,016 | A — complete 2026-07-11 (`29c1d28`); SyntaxHighlight end-to-end verified in tmux |

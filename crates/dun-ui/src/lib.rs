...
use dun_core::{
    DisplayClass, DisplaySanitizer, DisplaySegment, EditorCommand, Position, Rect, SanitizedLine,
...
pub(crate) use text::{
    decimal_digits, display_width, fit_text_to_width, status_text_for_width,

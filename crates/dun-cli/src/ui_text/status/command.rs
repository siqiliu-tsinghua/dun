...
pub(crate) const STATUS_PLUGIN_MENU_MNEMONIC_CONFLICT: TextKey = (
    "status.plugin.menu-mnemonic-conflict",
...
pub(crate) const STATUS_RUN_RETURNED_BACKGROUND_PROCESSES_KILLED: TextKey = (
    "status.run.returned-background-processes-killed",
    "Command returned {} in {}; background processes killed",
);
pub(crate) const STATUS_RUN_RETURNED_TRUNCATED_BACKGROUND_PROCESSES_KILLED: TextKey = (
    "status.run.returned-truncated-background-processes-killed",
    "Command returned {} in {}; output truncated; background processes killed",
);
pub(crate) const COMMAND_OUTPUT_STATUS_BACKGROUND_PROCESSES_KILLED: TextKey = (
    "command-output.status.background-processes-killed",
    "Status: {}; background processes killed",
);
...
pub(crate) const ALL: &[TextKey] = &[
    ...
    STATUS_RUN_RETURNED_TRUNCATED, STATUS_RUN_RETURNED_BACKGROUND_PROCESSES_KILLED,
    STATUS_RUN_RETURNED_TRUNCATED_BACKGROUND_PROCESSES_KILLED, STATUS_RUN_TIMED_OUT,
    STATUS_RUN_TIMED_OUT_TRUNCATED, STATUS_RUN_EXIT, STATUS_RUN_TERMINATED,
    COMMAND_OUTPUT_STATUS_BACKGROUND_PROCESSES_KILLED,
    STATUS_AUX_FOCUSED_WINDOW_MISSING, STATUS_AUX_WINDOW_MISSING, STATUS_HELP_OPENED,
